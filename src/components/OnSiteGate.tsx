    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background-dark px-4">
      <div className="max-w-sm rounded-lg border border-amber-500/30 bg-amber-500/10 p-6 text-center">
        ...
        <button
          type="button"
          onClick={onLogout}
          className="mt-6 min-h-[44px] touch-manipulation rounded-lg border border-line-strong bg-white/10 px-6 py-3 font-medium text-white transition-colors hover:bg-white/20"
        >
          Log out
        </button>
      </div>
