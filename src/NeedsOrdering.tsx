                        ...
                        <div className="flex items-center justify-between bg-white/5 px-4 py-2">
                          ...
                          {selectedCount > 0 && (
                            <button
                              ...
                              className="flex items-center gap-1 rounded-sm bg-primary px-3 py-1.5 text-xs font-bold text-on-accent"
                            >
        ...
        <div className="safe-area-pb fixed bottom-0 left-0 right-0 z-[45] border-t border-white/10 bg-card-dark px-4 py-3">
          <div className="mx-auto flex max-w-4xl items-center justify-between">
            ...
            <button
              ...
              disabled={isProcessing}
              className="flex items-center gap-2 rounded-sm bg-primary px-6 py-3 font-bold text-on-accent"
            >
              {isProcessing ? (
                <>
