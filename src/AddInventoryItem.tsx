...
const FIELD_INPUT_CLASS =
  'min-w-0 flex-1 rounded-lg border border-line bg-white/5 px-4 py-3 text-white focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary';
...
const ScannableInput: React.FC<{
  ...
  <div className="flex gap-2">
    ...
    <button
      type="button"
      onClick={onScan}
      className="flex shrink-0 items-center gap-1.5 rounded-lg border border-line bg-white/5 px-4 font-bold text-white hover:bg-white/10 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary"
        ...
        <Card className="space-y-4">
          ...
          <FormField label="Description" htmlFor="description">
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-lg border border-line bg-white/5 px-4 py-3 text-white focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </FormField>
